...
public partial class ApiDbTestContext : DbContext
{
    ...
    public virtual DbSet<EntradaMercanciaDetalle> EntradaMercanciaDetalles { get; set; }

    public virtual DbSet<SalidaMercancia> SalidaMercancias { get; set; }

    public virtual DbSet<SalidaMercanciaDetalle> SalidaMercanciaDetalles { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            optionsBuilder.UseSqlServer("Name=ConnectionStrings:API_DB");
        }
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Articulo>(entity =>
        {
            ...
            entity.HasOne(d => d.SerieNavigation).WithMany(p => p.Articulos)
                .HasForeignKey(d => d.Serie)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_articulo_serie");
        });
        ...
        {
            entity.HasKey(e => new { e.Entry, e.NoLinea }).HasName("pk_cotizacion_det");
            ...
            entity.HasOne(d => d.CodAlmacenNavigation).WithMany(p => p.CotizacionDetalles)
                .HasForeignKey(d => d.CodAlmacen)
                .HasConstraintName("fk_cot_det_almacen");

            entity.HasOne(d => d.CodArticuloNavigation).WithMany(p => p.CotizacionDetalles)
                .HasForeignKey(d => d.CodArticulo)
                .HasConstraintName("fk_cot_det_cod_art");
        });
        ...
        {
            entity.HasKey(e => e.Entry).HasName("pk_pedido_compra");
            ...
            entity.HasOne(d => d.CodigoSnNavigation).WithMany(p => p.PedidoCompras)
                .HasForeignKey(d => d.CodigoSn)
                .HasConstraintName("fk_pedido_compra_sn");

            entity.HasOne(d => d.MonedaDocNavigation).WithMany(p => p.PedidoCompras)
                .HasForeignKey(d => d.MonedaDoc)
                .HasConstraintName("fk_pedido_compra_moneda");

            entity.HasOne(d => d.SerieNavigation).WithMany(p => p.PedidoCompras)
                .HasForeignKey(d => d.Serie)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_pedido_compra_serie");
        });

        modelBuilder.Entity<PedidoCompraDetalle>(entity =>
        {
            entity.HasKey(e => new { e.Entry, e.NoLinea }).HasName("pk_pedido_compra_det");

            entity.ToTable("PedidoCompraDetalle");
            ...
            entity.HasOne(d => d.CodAlmacenNavigation).WithMany(p => p.PedidoCompraDetalles)
                .HasForeignKey(d => d.CodAlmacen)
                .HasConstraintName("fk_pedido_compra_det_almacen");

            entity.HasOne(d => d.CodArticuloNavigation).WithMany(p => p.PedidoCompraDetalles)
                .HasForeignKey(d => d.CodArticulo)
                .HasConstraintName("fk_pedido_compra_det_cod_art");

            entity.HasOne(d => d.CodigoImpuestoNavigation).WithMany(p => p.PedidoCompraDetalles)
                .HasForeignKey(d => d.CodigoImpuesto)
                .HasConstraintName("fk_pedido_compra_det_cod_impuesto");
        });
        ...
        modelBuilder.Entity<EntregaCompra>(entity =>
        {
            entity.HasKey(e => e.Entry).HasName("pk_entrega_compra");

            entity.ToTable("EntregaCompra");
            ...
            entity.HasOne(d => d.CodigoSnNavigation).WithMany(p => p.EntregaCompras)
                .HasForeignKey(d => d.CodigoSn)
                .HasConstraintName("fk_entrega_compra_sn");

            entity.HasOne(d => d.MonedaDocNavigation).WithMany(p => p.EntregaCompras)
                .HasForeignKey(d => d.MonedaDoc)
                .HasConstraintName("fk_entrega_compra_moneda");

            entity.HasOne(d => d.SerieNavigation).WithMany(p => p.EntregaCompras)
                .HasForeignKey(d => d.Serie)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_entrega_compra_serie");
        });

        modelBuilder.Entity<EntregaCompraDetalle>(entity =>
        {
            entity.HasKey(e => new { e.Entry, e.NoLinea }).HasName("pk_entrega_compra_det");

            entity.ToTable("EntregaCompraDetalle");
            ...
            entity.HasOne(d => d.CodAlmacenNavigation).WithMany(p => p.EntregaCompraDetalles)
                .HasForeignKey(d => d.CodAlmacen)
                .HasConstraintName("fk_entrega_compra_det_almacen");

            entity.HasOne(d => d.CodArticuloNavigation).WithMany(p => p.EntregaCompraDetalles)
                .HasForeignKey(d => d.CodArticulo)
                .HasConstraintName("fk_entrega_compra_det_cod_art");

            entity.HasOne(d => d.CodigoImpuestoNavigation).WithMany(p => p.EntregaCompraDetalles)
                .HasForeignKey(d => d.CodigoImpuesto)
                .HasConstraintName("fk_entrega_compra_det_cod_impuesto");
        });
        ...
        modelBuilder.Entity<EntradaMercancia>(entity =>
        {
            ...
            entity.Property(e => e.EstadoInv)
                ...
                .HasDefaultValueSql("('A')");
            entity.Property(e => e.FechaCancelado).HasColumnType("datetime");
            entity.Property(e => e.FechaContab).HasColumnType("datetime");
            entity.Property(e => e.FechaDoc).HasColumnType("datetime");
            entity.Property(e => e.Imprimido)
                .HasMaxLength(1)
                .HasDefaultValueSql("('N')");
            ...
            entity.HasOne(d => d.SerieNavigation).WithMany(p => p.EntradaMercancias)
                .HasForeignKey(d => d.Serie)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_entrada_mercancia_serie");
        });

        modelBuilder.Entity<EntradaMercanciaDetalle>(entity =>
        {
            ...
            entity.HasOne(d => d.CodAlmacenNavigation).WithMany(p => p.EntradaMercanciaDetalles)
                .HasForeignKey(d => d.CodAlmacen)
                .HasConstraintName("fk_entrada_mercancia_det_almacen");

            entity.HasOne(d => d.CodArticuloNavigation).WithMany(p => p.EntradaMercanciaDetalles)
                .HasForeignKey(d => d.CodArticulo)
                .HasConstraintName("fk_entrada_mercancia_det_cod_art");
        });

        modelBuilder.Entity<SalidaMercancia>(entity =>
        {
            entity.HasKey(e => e.Entry).HasName("pk_salida_mercancia");

            entity.ToTable("SalidaMercancia");
            ...
            entity.HasOne(d => d.SerieNavigation).WithMany(p => p.SalidaMercancias)
                .HasForeignKey(d => d.Serie)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_salida_mercancia_serie");
        });

        modelBuilder.Entity<SalidaMercanciaDetalle>(entity =>
        {
            entity.HasKey(e => new { e.Entry, e.NoLinea }).HasName("pk_salida_mercancia_det");
            ...
            entity.HasOne(d => d.CodAlmacenNavigation).WithMany(p => p.SalidaMercanciaDetalles)
                .HasForeignKey(d => d.CodAlmacen)
                .HasConstraintName("fk_salida_mercancia_det_almacen");

            entity.HasOne(d => d.CodArticuloNavigation).WithMany(p => p.SalidaMercanciaDetalles)
                .HasForeignKey(d => d.CodArticulo)
                .HasConstraintName("fk_salida_mercancia_det_cod_art");
        });
        ...
        {
            entity.HasKey(e => e.Entry).HasName("pk_factura_compra");
            ...
            entity.HasOne(d => d.CodigoSnNavigation).WithMany(p => p.FacturaCompras)
                .HasForeignKey(d => d.CodigoSn)
                .HasConstraintName("fk_factura_compra_sn");

            entity.HasOne(d => d.MonedaDocNavigation).WithMany(p => p.FacturaCompras)
                .HasForeignKey(d => d.MonedaDoc)
                .HasConstraintName("fk_factura_compra_moneda");

            entity.HasOne(d => d.SerieNavigation).WithMany(p => p.FacturaCompras)
                .HasForeignKey(d => d.Serie)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_factura_compra_serie");
        });

        modelBuilder.Entity<FacturaCompraDetalle>(entity =>
        {
            entity.HasKey(e => new { e.Entry, e.NoLinea }).HasName("pk_factura_compra_det");

            entity.ToTable("FacturaCompraDetalle");
            ...
            entity.HasOne(d => d.CodAlmacenNavigation).WithMany(p => p.FacturaCompraDetalles)
                .HasForeignKey(d => d.CodAlmacen)
                .HasConstraintName("fk_factura_compra_det_almacen");

            entity.HasOne(d => d.CodArticuloNavigation).WithMany(p => p.FacturaCompraDetalles)
                .HasForeignKey(d => d.CodArticulo)
                .HasConstraintName("fk_factura_compra_det_cod_art");

            entity.HasOne(d => d.CodigoImpuestoNavigation).WithMany(p => p.FacturaCompraDetalles)
                .HasForeignKey(d => d.CodigoImpuesto)
                .HasConstraintName("fk_factura_compra_det_cod_impuesto");
        });
        ...
        {
            entity.HasKey(e => e.Codigo).HasName("pk_impuesto");

            entity.ToTable("Impuesto");

            entity.Property(e => e.Codigo).HasMaxLength(8);
            entity.Property(e => e.Nombre).HasMaxLength(100);
            entity.Property(e => e.Tasa).HasColumnType("decimal(21, 6)");
        });
        ...
        modelBuilder.Entity<SocioNegocio>(entity =>
        {
            ...
            entity.HasOne(d => d.SerieNavigation).WithMany(p => p.SocioNegocios)
                .HasForeignKey(d => d.Serie)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_sn_serie");
        });
