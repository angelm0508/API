...
namespace API.Service.WebApi.Tests.Controllers
{
    public class GrupoMedidaArticuloControllerTests
    {
        ...
        {
            var dto = new GrupoMedidaArticuloDTO { Entry = 1, Nombre = "Grupo Medida 1" };
        ...
        {
            var respuesta = new Respuesta<IEnumerable<GrupoMedidaArticuloDTO>> { Resultado = true, Dato = new List<GrupoMedidaArticuloDTO> { new GrupoMedidaArticuloDTO { Entry = 1 } } };
            _applicationMock.Setup(a => a.ObtenerContengaNombreAsync("Gru")).ReturnsAsync(respuesta);
        ...
        public async Task ActualizarAsync_DevuelveBadRequest_CuandoActualizarFalla()
        {
            _applicationMock.Setup(a => a.ObtenerAsync(1))
                .ReturnsAsync(new Respuesta<GrupoMedidaArticuloDTO> { Resultado = true, Dato = new GrupoMedidaArticuloDTO { Entry = 1 } });
