    ...
    public class GrupoMedidaArticuloControllerTests
    {
        ...
        public async Task Obtener_DevuelveBadRequest_CuandoResultadoEsFalso()
        {
            _applicationMock.Setup(a => a.ObtenerAsync(1))
                .ReturnsAsync(new Respuesta<GrupoMedidaArticuloDTO> { Resultado = false, Mensaje = "error" });
        ...
        {
            _applicationMock.Setup(a => a.ObtenerAsync(1))
                .ReturnsAsync(new Respuesta<GrupoMedidaArticuloDTO> { Resultado = true, Dato = null! });
        ...
        public async Task Obtener_DevuelveOk_CuandoExiste()
        {
            ...
            _applicationMock.Setup(a => a.ObtenerAsync(1))
                .ReturnsAsync(new Respuesta<GrupoMedidaArticuloDTO> { Resultado = true, Dato = dto });
        ...
        {
            _applicationMock.Setup(a => a.ObtenerAsync("Grupo Medida 1"))
                .ReturnsAsync(new Respuesta<GrupoMedidaArticuloDTO> { Resultado = false, Mensaje = "error" });
        ...
        public async Task ObteneContengaNombreAsync_DevuelveBadRequest_CuandoResultadoEsFalso()
        {
            _applicationMock.Setup(a => a.ObtenerContengaNombreAsync("Gru"))
                .ReturnsAsync(new Respuesta<IEnumerable<GrupoMedidaArticuloDTO>> { Resultado = false, Mensaje = "error" });
        ...
        {
            var datos = new List<GrupoMedidaArticuloDTO> { new GrupoMedidaArticuloDTO { Codigo = 1 } };
            _applicationMock.Setup(a => a.ObtenerContengaNombreAsync("Gru"))
                .ReturnsAsync(new Respuesta<IEnumerable<GrupoMedidaArticuloDTO>> { Resultado = true, Dato = datos });
        ...
        public async Task ActualizarAsync_DevuelveBadRequest_CuandoActualizarFalla()
        {
            ...
            _applicationMock.Setup(a => a.ActualizarAsync(1, It.IsAny<GrupoMedidaArticuloActualizarDTO>()))
