    ...
    public class MedidaArticuloControllerTests
    {
        ...
        public async Task Obtener_DevuelveBadRequest_CuandoResultadoEsFalso()
        {
            _applicationMock.Setup(a => a.ObtenerAsync(1))
                .ReturnsAsync(new Respuesta<MedidaArticuloDTO> { Resultado = false, Mensaje = "error" });
        ...
        {
            _applicationMock.Setup(a => a.ObtenerAsync(1))
                .ReturnsAsync(new Respuesta<MedidaArticuloDTO> { Resultado = true, Dato = null! });
        ...
        public async Task Obtener_DevuelveOk_CuandoExiste()
        {
            ...
            _applicationMock.Setup(a => a.ObtenerAsync(1))
                .ReturnsAsync(new Respuesta<MedidaArticuloDTO> { Resultado = true, Dato = dto });
        ...
        {
            _applicationMock.Setup(a => a.ObtenerAsync("ME1"))
                .ReturnsAsync(new Respuesta<MedidaArticuloDTO> { Resultado = false, Mensaje = "error" });
        ...
        {
            _applicationMock.Setup(a => a.ObtenerContengaNombreAsync("Med"))
                .ReturnsAsync(new Respuesta<IEnumerable<MedidaArticuloDTO>> { Resultado = false, Mensaje = "error" });
        ...
        public async Task ObteneContengaNombreAsync_DevuelveOk_CuandoResultadoEsExitoso()
        {
            ...
            _applicationMock.Setup(a => a.ObtenerContengaNombreAsync("Med"))
                .ReturnsAsync(new Respuesta<IEnumerable<MedidaArticuloDTO>> { Resultado = true, Dato = datos });
        ...
        public async Task ActualizarAsync_DevuelveBadRequest_CuandoActualizarFalla()
        {
            ...
            _applicationMock.Setup(a => a.ActualizarAsync(1, It.IsAny<MedidaArticuloActualizarDTO>()))
