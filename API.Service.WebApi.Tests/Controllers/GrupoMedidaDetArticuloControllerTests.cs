    ...
    public class GrupoMedidaDetArticuloControllerTests
    {
        ...
        public async Task Obtener_DevuelveBadRequest_CuandoResultadoEsFalso()
        {
            _applicationMock.Setup(a => a.ObtenerAsync(1))
                .ReturnsAsync(new Respuesta<GrupoMedidaDetArticuloDTO> { Resultado = false, Mensaje = "error" });
        ...
        {
            _applicationMock.Setup(a => a.ObtenerAsync(1))
                .ReturnsAsync(new Respuesta<GrupoMedidaDetArticuloDTO> { Resultado = true, Dato = null! });
        ...
        public async Task Obtener_DevuelveOk_CuandoExiste()
        {
            ...
            _applicationMock.Setup(a => a.ObtenerAsync(1))
                .ReturnsAsync(new Respuesta<GrupoMedidaDetArticuloDTO> { Resultado = true, Dato = dto });
        ...
        public async Task ObtenerTodoAsync_DevuelveBadRequest_CuandoResultadoEsFalso()
        {
            _applicationMock.Setup(a => a.ObtenerTodoAsync())
                .ReturnsAsync(new Respuesta<IEnumerable<GrupoMedidaDetArticuloDTO>> { Resultado = false, Mensaje = "error" });
        ...
        {
            var datos = new List<GrupoMedidaDetArticuloDTO> { new GrupoMedidaDetArticuloDTO { Codigo = 1 } };
            _applicationMock.Setup(a => a.ObtenerTodoAsync())
                .ReturnsAsync(new Respuesta<IEnumerable<GrupoMedidaDetArticuloDTO>> { Resultado = true, Dato = datos });
        ...
        public async Task ActualizarAsync_DevuelveBadRequest_CuandoActualizarFalla()
        {
            ...
            _applicationMock.Setup(a => a.ActualizarAsync(1, It.IsAny<GrupoMedidaDetArticuloActualizarDTO>()))
