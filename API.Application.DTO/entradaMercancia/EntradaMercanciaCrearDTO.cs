...
namespace API.Application.DTO.entradaMercancia
{
    public class EntradaMercanciaCrearDTO
    {
        ...
        // servidor calcula el siguiente número al momento de registrar la entrada de mercancía (ver
        // EntradaMercanciaDomain.InsertarAsync), así que aquí no puede ser obligatorio.
        ...
        // La entrada de mercancía es un ajuste de inventario sin socio de negocio: el cliente no
