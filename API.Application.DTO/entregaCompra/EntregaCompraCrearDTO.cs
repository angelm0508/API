...
namespace API.Application.DTO.entregaCompra
{
    public class EntregaCompraCrearDTO
    {
        // Requerido solo cuando la serie elegida es "Manual" -- para series autogeneradas el
        // servidor calcula el siguiente número al momento de registrar la entrega de compra (ver
        // EntregaCompraDomain.InsertarAsync), así que aquí no puede ser obligatorio.
